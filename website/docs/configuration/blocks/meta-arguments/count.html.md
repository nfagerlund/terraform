...
`count` and [`for_each`](/docs/configuration/blocks/meta-arguments/for_each.html).
...
The `count` meta-argument accepts numeric [expressions](/docs/configuration/expressions.html).
