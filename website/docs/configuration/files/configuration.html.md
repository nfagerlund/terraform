---
layout: "language"
page_title: "Configuration Files - Files and Directories - Configuration Language"
---

# Configuration Files

Code in the Terraform language is stored in plain text files. Files containing
Terraform code are often called _configuration files._

## File Extension

Configuration files use the `.tf` file extension.

The [JSON-based variant of the language](/docs/configuration/syntax-json.html)
